...
class _DoneSheet extends StatelessWidget {
  const _DoneSheet({required this.total});
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFF102032), Color(0xFF0A0D18)],
        ),
      ),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Seu check-in de ontem foi fechado com $total respostas.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          Text(
            'Toque na opção que mais combina com ontem.',
            style: TextStyle(
