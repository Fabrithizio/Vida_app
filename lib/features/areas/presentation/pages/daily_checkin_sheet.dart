...
class _DailyCheckinSheetState extends State<DailyCheckinSheet> {
  ...
  String _profileLabel = 'Em adaptação';
  ...
  Future<void> _boot() async {
    ...
    final profileLabel = await _service.currentProfileLabel(now: _day);
          ...
          children: [
            Row(
              children: [
                ...
                _ProfileBadge(label: _profileLabel),
                const Spacer(),
                IconButton(
                  onPressed: _saving
                      ? null
            ...
            Text(
              'Seu check-in está adaptado ao seu perfil atual e cruza sinais de várias áreas.',
              style: TextStyle(
